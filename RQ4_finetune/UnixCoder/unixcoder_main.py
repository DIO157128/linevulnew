...
def test(args, model, tokenizer, test_dataset, best_threshold=0.5):
    ...
    f = open("../results/unixcoder/func_res_{}.txt".format(args.fine_tune_factor), "a")
    for key in sorted(result.keys()):
    ...
    if args.do_sorting_by_line_scores:
        ...
        for reasoning_method in all_reasoning_method:
            ...
            with open("../results/unixcoder/line_res_{}.txt".format(args.fine_tune_factor), "a") as f:
                f.write(to_write)
    ...
    if args.do_local_explanation:
        for reasoning_method in all_reasoning_method:
            ...
            with open(f"../results/ifa_records/unixcoder_ifa_{reasoning_method}_{args.fine_tune_factor}.txt", "w+") as f:
            ...
            # output results
            with open("../results/unixcoder/local_explanation_{}.txt".format(args.fine_tune_factor), "a") as f:
...
def write_raw_preds_csv(args, y_preds):
    ...
    df.to_csv("../results/unixcoder/raw_preds_{}.csv".format(args.fine_tune_factor), index=False)
