...
def test(args, model, tokenizer, test_dataset, best_threshold=0.5):
    ...
    f = open("../results/gpt2/func_res_{}.txt".format(args.fine_tune_factor), "a")
    for key in sorted(result.keys()):
    ...
    if args.do_local_explanation:
        for reasoning_method in all_reasoning_method:
            ...
            with open(f"../results/ifa_records/gpt2_ifa_{reasoning_method}_{args.fine_tune_factor}.txt", "w+") as f:
            ...
            # output results
            with open("../results/gpt2/local_explanation_{}.txt".format(args.fine_tune_factor), "a") as f:
...
def write_raw_preds_csv(args, y_preds):
    ...
    df.to_csv("../results/gpt2/raw_preds_{}.csv".format(args.fine_tune_factor), index=False)
