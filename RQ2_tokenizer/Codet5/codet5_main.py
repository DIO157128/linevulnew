...
def test(args, model, tokenizer, test_dataset, best_threshold=0.5):
    ...
    f = open("../results/codet5/func_res.txt", "a")
    for key in sorted(result.keys()):
    ...
    if args.do_local_explanation:
        for reasoning_method in all_reasoning_method:
            ...
            with open(f"../results/ifa_records/codet5_ifa_{reasoning_method}.txt", "w+") as f:
            ...
            # output results
            with open("../results/codet5/local_explanation.txt", "a") as f:
...
def write_raw_preds_csv(args, y_preds):
    ...
    df.to_csv("../results/codet5/raw_preds.csv", index=False)
...
def main():
    ...
    tokenizer = Tokenizer.from_file('./codet5.json')
